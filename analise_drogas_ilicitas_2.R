...
# Uso de drogas ilícitas no Japão ----------------------------------------------------------------------------------------------------------
...
plot_japao <- grid.arrange(g1, g2, g3, g4, ncol = 2,  # ncol se refere a número de colunas
                    top = textGrob("Japão", gp = gpar(fontsize = 22, col = "#4575b4")))

# Salvar gráfico ---------------------------------------------------------------------------------------------------------------------------

ggsave("plot_japao.pdf", plot_japao, width = 15, height = 15)
